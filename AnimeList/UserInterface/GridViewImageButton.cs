...
{
    /// <summary>
    /// Simple grid view button with an image background.
    /// </summary>
    public class GridViewImageButton : IGridViewCell
    {
        public delegate void OnClickDelegate(GridViewImageButton button);
